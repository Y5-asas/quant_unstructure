...
# 定义 "道格斯28" 公司列表 (ticker -> 公司名 映射)
# 注意：Dogs of the Dow 通常是30只，这里按您的"28"处理，您可以根据实际列表调整
DOGS_OF_30 = [
    "MMM",  # 3M Company
...
# 输出目录
base_output_dir = "dogs_of_30_mdna"
        ...
        for i, metadata in enumerate(metadatas, start=1):
            try:
                ...
                if not mdna_sections:
                    print(f"      策略1失败，尝试策略2: 基于Item编号的智能匹配...")
...
if __name__ == "__main__":
    ...
    print("  └── MSFT/")
    print("      ├── MSFT_2024_Annual_20240630_mdna.md")
    print("      ├── MSFT_2024_Q3_20240930_mdna.md")
    print("      ├── MSFT_2024_Q2_20240630_mdna.md")
    print("      └── ...")